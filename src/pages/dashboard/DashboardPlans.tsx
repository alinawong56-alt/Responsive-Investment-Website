...
export default function DashboardPlans() {
  ...
  if (loading) {
    return (
      <div>
        <h1 className="text-3xl font-black">Investment Plans</h1>

        <p className="mt-3" style={{ color: "#9090a8" }}>
    ...
    <div>
      <div className="mb-8">
        ...
        <p className="mt-3 text-sm" style={{ color: "#9090a8" }}>
          Choose an available plan and invest using your wallet balance.
        </p>
      </div>
      ...
      >
        ...
        <button
          ...
          className="mt-4 px-5 py-3 text-sm font-bold"
          style={{
            background: "#d4a017",
            color: "#09090e",
          }}
      ...
      {selectedPlan && (
        ...
        >
          ...
          <p className="mt-2 text-sm" style={{ color: "#9090a8" }}>
            Minimum investment: {money(selectedPlan.minimum_amount)}
          </p>
